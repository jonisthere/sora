...
add_action('init', 'ace_farbtastic_script');
...
<div id="options-form">
  ...
  <div id="options-header">
    ...
    <div class="meta"><a href="<?php echo esc_url( 'http://bluchic.com/support/knowledgebase.php' ); ?>">Documentation<a/> | <a href="<?php echo esc_url( 'http://www.bluchic.com/support' ); ?>">Support Ticket</a> | <a href="<?php echo esc_url( 'https://twitter.com/hibluchic' ); ?>">Twitter</a> | <a href="<?php echo esc_url( 'https://www.facebook.com/bluchic' ); ?>">Facebook</a></div>
  </div>
...
<form method="post">
  ...
  <ul class="toplist">
    ...
    <li><a href="#socials"><?php _e( 'Social media settings','ace' ); ?></a></li>
...
<?php } elseif ($value['type'] == 'upload') { ?>
  ...
  <div class="wrap">
    ...
    <input onfocus="this.select();" class="uploaded_image" type="text" id="<?php echo $value['id']; ?>" name="<?php echo $value['id']; ?>" value="<?php echo get_option( $value['id'] ); ?>" /> <a href="media-upload.php?keepThis=true&amp;TB_iframe=true&amp;width=640&amp;height=auto" class="thickbox"><?php _e('Upload','ace'); ?></a><br />
    <?php } else { ?>
    <input onfocus="this.select();" class="uploaded_image" type="text" id="<?php echo $value['id']; ?>" name="<?php echo $value['id']; ?>" value="<?php if ( get_option( $value['id'] ) != "") { echo get_option( $value['id'] ); } else { echo $value['std']; } ?>" /> <a href="media-upload.php?keepThis=true&amp;TB_iframe=true&amp;width=640&amp;height=auto" class="thickbox"><?php _e('Upload','ace'); ?></a><br />
    <?php } ?>
