...
function tooltip( $atts, $content = null ) {
  ...
  return '<span class="tooltip">'.do_shortcode($content).'<span class="tip radius-2">'.$text.'</span></span>';
}
...
function button_code( $atts, $content = null ) {
  ...
  return '<a href="'.$url.'" class="post-button radius-4">'.do_shortcode($content).'</a>';
}
...
function accordion_code( $atts, $content = null ) {
  ...
  // $content = parse_shortcode_content( $content );
  return '<section class="accordion-wrap"><article class="accordion-title radius-4">'.$title.'</article><article class="accordion-content">'.do_shortcode($content).'</article></section>';
}
...
function contactForm()	{
  ...
  $content .= '<input name="name" type="text" class="contact-form-text" id="name" title="Name" />';
  $content .= '<input name="email" type="text" class="contact-form-text" id="email" title="Email" />';
  $content .= '<input name="mobile" type="text" class="contact-form-text" id="mobile" title="Mobile" />';
  $content .= '<textarea rows="" cols="" class="contact-form-textarea" name="message" title="Message"></textarea>';
  $content .= '<input type="submit" value="Submit" class="contact-form-button" id="contact-submit" />';
  $content .= '</form>';
