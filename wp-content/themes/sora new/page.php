								...
								<section class="entry-content">
									...
									<div class="treatment-content-area">
										...
										<?php if(get_field('conditions', 6)): ?>
											...
											<li <?php echo  ($x == 1 ? 'class="active" style="display:block"' : '') ?>>
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article">
								<section class="">
									...
									<ul class="treatment-text">
										<?php while ($treatments->have_posts()) : $treatments->the_post(); ?>
											<li data-name="<?php echo $post->post_name ?>" class="<?php echo $post->post_name ?> <?php echo  ($x == 1 ? 'active' : '') ?>"><?php the_content(); ?></li>
										<?php $x++; ?>
										<?php endwhile; ?>
									</ul>
...
console.log(Width);
    if (Width > 600) {
	    jQuery(".section-1").anystretch("<?php echo get_template_directory_uri();?>/library/backgrounds/homepage1.jpg");
	} else {
	...
	if (Width > 400) {
	    ...
	    jQuery(".section-4").anystretch("<?php echo get_template_directory_uri();?>/library/backgrounds/pricelist_.jpg");
	    jQuery(".section-5").anystretch("<?php echo get_template_directory_uri();?>/library/backgrounds/whychose2.jpg");
	    jQuery(".section-6").anystretch("<?php echo get_template_directory_uri();?>/library/backgrounds/About-us.jpg");
	    jQuery(".section-7").anystretch("<?php echo get_template_directory_uri();?>/library/backgrounds/booking_sora.jpg");

	    jQuery(".section-3-b").anystretch("<?php echo get_template_directory_uri();?>/library/backgrounds/treatment_boxes.jpg");
