 ...
 * Template Name: Registration Form PART 2 
		...
		<div class="col-xs-12">
													...
													<div class="register-top-section form-container">
														<div class="row">
															<div class="col-xs-12 col-sm-6">	  
																<select name="user_title" class="form-control form-dropdown">
			...
			'role'		=>	'None' */ ?>
																  ...
																  <div class="form-group">
																    ...
																    <input name="first_name" type="firstname" class="form-control" id="InputFirstname" placeholder="First Name">
																  </div>
																  <div class="form-group form-group-pw">
																    <!-- <label for="exampleInputPassword">Password:</label> -->
																    <input name="last_name" class="form-control" id="InputSurname" placeholder="Surname">
																  </div>
																  <div class="form-group">
																    <input name="email_address" class="form-control" id="InputEmail" placeholder="Email" name="email" >
																  </div>
																  <div class="form-group">
																    <input name="email_address_confirm" class="form-control" id="InputConfirmEmail" placeholder="Confirm email">
																  </div>
																  <select name="matriculation" class="form-control form-dropdown">
															...
															<div class="col-xs-12 col-sm-6">
																<div class="form-group">
																	<input name="user_name" type="firstname" class="form-control" id="InputUsername" placeholder="User Name">
																</div>
																
																<div class="form-group">
																	<input name="zip_code" type="firstname" class="form-control" id="InputUsername" placeholder="ZIP">
																</div>
																<div class="form-group form-group-pw hide-on-phase-two-register">
																	<input name="password" type="password" class="form-control" id="InputPassword" placeholder="Password">
																</div>
																<div class="form-group form-group-pw hide-on-phase-two-register">
																	<input name="password_confirm" type="password" class="form-control" id="InputConfirmPassword" placeholder="Confirm Password">
																</div>
