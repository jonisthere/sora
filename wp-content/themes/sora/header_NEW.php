...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<body <?php body_class(); ?>>
		...
		<div id="container" class="nav-bar-container">
			<a name="top"></a>
			<!-- nav row -->
			<div class="nav-bar">
					...
					<div class="row">
						<div class="col-xs-12">
							<header class="header" role="banner">
										...
										<div class="login-register padding-wrap">
											...
											<div class="register-tabs">
												...
												<?php global $current_user;
													 ...
													 get_currentuserinfo();
													?>
												<a href="<?php echo get_site_url() ?>/user-area/">
													<?php echo 'Hello ' . $current_user->user_firstname . ' ' . $current_user->user_lastname;	?>
												</a> | <a href="<?php echo wp_logout_url(jw_get_post_info()); ?>" title="Logout">Logout</a>
											</div>
											<?php } else { ?> 
											<div class="register-tabs">
												<a href="<?php echo get_site_url() ?>/please-sign-in">Login/Register</a>
											</div>
											<?php } ?>
								...
								<div class="map-img-left"></div>
								
								<div class="map-img-right"></div>
