...
add_image_size( 'blog-featured-img', 512, 274, true );
...
function jw_dc_register_user_1() {
...
function acme_email_individual( $input ) {
    ...
    $message .= '</ul>';
    $message .= '<br />';
    $message .= 'You can login to the application <a href="' . 'work this out ' . '">here</a>.';
