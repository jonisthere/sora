...
function custom_post_example() { 
	...
	register_post_type( 'people', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'singular_name' => __( 'People', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'People', 'bonestheme' ), /* the all items menu item */
	...
	// Custom post type for PEOPLE
	register_post_type( 'we-support', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'We Support', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'We Support', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'We Support', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New We Support Item', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Edit We Support Item', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New We Support Item', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View We Support Item', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search We Support', 'bonestheme' ), /* Search Custom Type Title */ 
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
	...
	register_post_type( 'matriculation', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Matriculation', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Matriculation', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'Matriculation List', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New Matriculation Name', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Matriculation Name', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			...
			'search_items' => __( 'Search Matriculation List', 'bonestheme' ), /* Search Custom Type Title */ 
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			...
			'menu_position' => 8, /* this is what order you want it to appear in on the left hand side menu */ 
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/custom-post-icon.png', /* the icon for the custom post type menu */
			'rewrite'	=> array( 'slug' => 'matriculation-list', 'with_front' => false ), /* you can specify its url slug */
