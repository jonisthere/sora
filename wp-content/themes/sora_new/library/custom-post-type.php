...
function custom_post_example() { 
	...
	register_post_type( 'treatments', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			'name' => __( 'Treatments', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Treatment', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All Treatments', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Treatment', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Edit Treatments Types', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New Treatment Type', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View Treatment Type', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search Treatment Type', 'bonestheme' ), /* Search Custom Type Title */ 
